...
class EventEmitterWithWaitFor extends EventEmitter {
     ...
     * @param {string} event - The event name to wait for
        * @param {number|((...args: any[]) => boolean)|import('./types').WaitForOptions} [options] - Timeout in ms, filter function, or options object
        * @returns {any} A cancelable promise that resolves with event arguments
     */
